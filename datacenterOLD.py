...
packed = "DataCenter_Final_EUR.dat"

key = bytes(bytearray.fromhex("C159B46AB0DDF451CECF415990F08760"))
iv = bytes(bytearray.fromhex("BFB16D41B91F11574F0E8D3CD492EB43"))
...
open("DataCenter_Final_EUR.dat2", "wb").write(packed)
